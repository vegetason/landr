...
export function ResumeClientPage({jobInfoId}:{jobInfoId:string}){
    ...
    function handleFileUpload(file:File|null){
        ...
        if(!allowedTypes.includes(file.type)){
            toast.error("Please upload a PDF,word document or a text file")
            return
        }
    ...
    return <div className="space-y-8 w-full">
        <Card>
            <CardHeader>
                <CardTitle>{isLoading? "Analysing Your Resume": "Upload Your Resume"}</CardTitle>
                <CardDescription>{isLoading? "This may take a minute":"Get Personalized feedback based on the job"}</CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <LoadingSwap isLoading={isLoading} loadingIconClassName="size-16">
                        <div className="flex flex-col items-center justify-center text-center gap-4">
                            ...
                            <div className="space-y-2">
                                <p className="text-lg">
                                    Drag your resume or click to upload
                                </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {category?.feedback == null ? (
                        ...
                        category.feedback.map((item:unknown, index:number) => {
